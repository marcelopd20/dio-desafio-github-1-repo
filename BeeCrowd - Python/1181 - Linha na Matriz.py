...
M[12][12]. Em seguida, calcule e mostre a soma ou a média dos elementos que estão na área verde da matriz, conforme
for o caso. A imagem abaixo ilustra o caso da entrada do valor 2 para a linha da matriz, demonstrando os elementos
...
for l in range(12):
    ...
    C.append(L.copy())
    L.clear()
for i, v in enumerate(C[Lin]):
    a += v
print(f'{a:.1f}') if Car in 'Ss' else print(f'{a/12:.1f}')
