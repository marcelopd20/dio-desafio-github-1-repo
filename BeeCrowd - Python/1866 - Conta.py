...
mais, não precisaria pagar a conta. Então foi proposto o seguinte: Dado o seguinte somatório abaixo,
...
um número inteiro N (1 ≤ N ≤ 1000), indicando a quantidade de termos da soma.

Saída
Para cada caso de teste imprima um número S, que é o resultado da soma dos N termos da expressão."""
N = int(input())
[print(0) if int(c) % 2 == 0 else print(1) for b in range(N) for c in input().split()]